...
class IndexController extends Controller
{
    public function Index(){
        ...
        return view('frontend.index',compact('skip_category_0','skip_product_0','skip_category_2','skip_product_2','skip_category_3','skip_product_3',
        'hot_deals','special_offer','recently_added','special_deals'));
  ...
  public function SearchProduct(Request $request){///to show search item in search bar
